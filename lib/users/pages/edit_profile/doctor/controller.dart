...
import 'package:booking_doctor/users/common/utils/invalid_exception.dart';
import 'package:booking_doctor/users/pages/edit_profile/doctor/index.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:booking_doctor/users/common/service/firebase_storage.dart';
...
class EditProfileDoctorController extends GetxController {
  ...
  _generateUser() async {
    await db
      ...
      state.workPlaceController.text = doctorUser.hospitalName ?? "";
  ...
  bool isAllValid() {
    ...
    if (doctorUser2.userName!.isNotEmpty &&
        doctorUser2.hospitalName!.isNotEmpty &&
  ...
  //TODO: Sửa lại thông tin nơi làm việc
  ...
  void handleSaveWorkProgress(BuildContext context) {
    ...
    //TODO: Chỉnh sửa lại
    // WorkExperience workProgress = WorkExperience(
  ...
  //TODO: Chỉnh sửa lại edit profile
  ...
  Future handleSave(BuildContext context) async {
    ...
    String? newPhotoUrl;
    if (photoFile != null) {
      newPhotoUrl = await FirebaseStorageService()
          .uploadImg(ref: "users", file: photoFile!);
    }
    await db
        .collection("users")
        .withConverter(
