import 'package:booking_doctor/users/common/entities/comment.dart';
...
import 'package:booking_doctor/users/pages/detail_question/controller.dart';
import 'package:booking_doctor/users/pages/detail_question/widget/comment_item.dart';
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                SizedBox(height: 5.h),
                Text(
                  formatDate(controller.state.question!.createdAt.toDate()),
                  style: getMyTextStyle(
                    fontSize: 14.sp,
                    color: Colors.grey,
                  ),
